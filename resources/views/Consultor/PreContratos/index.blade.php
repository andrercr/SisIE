...
<section class="content-header">
  <h1>
    {{ $dados_pagina->mapa or 'Gestão de Pré-Contratos'}}
    <small>Preview</small>
  </h1>
  <ol class="breadcrumb">
    ...
    <div class="col-xs-12">
      <div class="box box-default">
        <div class="box-header">
          <h3 class="box-title">Pré-Contratos</h3>
          <div class="box-tools">
            <div class="input-group input-group-sm" style="width: 150px;">
              <a href="{{route('precontratos.create')}}"><button class="btn btn-success pull-right"><span class="glyphicon glyphicon-plus"></span> Novo Pré-Contrato</button></a>
            </div>
          </div>
        </div>
